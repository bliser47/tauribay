...
<link type="text/css" rel="stylesheet" href="{{ URL::asset('css/style.css?v=215') }}"/>
<link type="text/css" rel="stylesheet" href="{{ URL::asset('css/responsive.css?v=10') }}"/>
...
<script type="application/javascript" src="{{ URL::asset('js/main.js?v=233') }}"></script>
