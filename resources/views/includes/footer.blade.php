...
<link rel="stylesheet" href="{{ URL::asset('css/style.css?v=205') }}"/>
<link rel="stylesheet" href="{{ URL::asset('css/responsive.css?v=7') }}"/>
...
<script type="text/javascript" src="{{ URL::asset('js/main.js?v=224') }}"></script>
