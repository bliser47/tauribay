...
<link rel="stylesheet" href="{{ URL::asset('css/style.css?v=184') }}"/>
<link rel="stylesheet" href="{{ URL::asset('css/responsive.css?v=2') }}"/>
...
<script type="text/javascript" src="{{ URL::asset('js/main.js?v=184') }}"></script>
